...
class HE{
    ...
    /* Carry-Look-Ahead Adder, Kogge-Stone Adder*/
		unsigned int depth(unsigned int bits);
    void KS_RED(mkt k1, mkt k2);
    void KS_GREEN(mkt k1, mkt k2, mkt o_p, mkt o_g);
    void KS_YELLOW(
        mkt p_in, mkt p_in_prev, mkt p_out,
        mkt g_in, mkt g_in_prev, mkt g_out);
    void KoggeStoneAdder(vector<mkt>& k1_bit, vector<mkt> k2_bit);
